...
func EncodeSimpleEntryView(clientMessage *proto.ClientMessage, simpleEntryView pubcontrol.SimpleEntryView) {
...
func DecodeSimpleEntryView(frameIterator *proto.ForwardFrameIterator) pubcontrol.SimpleEntryView {
	// begin frame
	frameIterator.Next()
	...
	return pubcontrol.SimpleEntryView{
		Key:            key,
		Value:          value,
		Cost:           cost,
